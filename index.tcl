...
puts "<tr>"
puts "<td>Первая точка СЕВЕР: </td><td><INPUT TYPE=\"text\" NAME=\"p1\"  value=90 SIZE=\"8\"></td>"
puts "<td>Вторая точка ВОСТОК: </td><td> <INPUT TYPE=\"text\" NAME=\"p2\" value=180 SIZE=\"8\"></td>"
puts "</tr><tr>"
